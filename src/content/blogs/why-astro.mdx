...
By using Astro, we can create website projects that are rendered in **SSR** (`Server Side Rendering`) or **SSG** (`Static Site Generation`) or **both at the same time** (`hybrid rendering`). But choosing one of these two main ways would greatly depend on your needs and resources for the project.
